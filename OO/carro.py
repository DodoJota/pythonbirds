...
Criar uma classe carro composta por outras duas classes:
1) Motor
2) Direção

O Motor controla a velocidade e tem dois atributos:
1) Atributo de dado velocidade
2) Método acelerar, que deverá incrementar a velocidade em uma unidade
3) Método frear, que deverá decrementar a velocidade em duas unidades

A Direção controla a direção e tem os seguintes atributos:
